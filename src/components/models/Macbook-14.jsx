...
Files: macbook-14.glb [629.72KB] > C:\Users\abdul\OneDrive\Desktop\agents\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
const{color}=useMacbookStore();
 ...
 useEffect(()=>{
    scene.traverse((child)=>
    {
      if(child.isMesh)
      {
        if(!noChangeParts.includes(child.nsame))
        {
